...
<head>
    ...
    <title>CWD Frontline Services</title>
...
<body>
    ...
    <div class="relative bg-[#1a589e] text-white overflow-hidden py-16 sm:py-20 md:py-24">
                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                    ...
                    <li>
                        <div class="flex items-center space-x-1.5">
                            ...
                            <a href="#"
                                class="inline-flex items-center text-m font-medium text-white hover:text-fg-brand"><i class="fa-solid fa-people-line mr-2"></i> Frontline
                                Services</a>
                        </div>
                    </li>
        ...
        <div class="container-fluid mx-auto text-center relative z-10 px-4">
            <h1 class="text-4xl md:text-5xl font-black text-white uppercase tracking-tight mb-4">Frontline Services
            </h1>
    ...
    <?php include 'includes/flserv300.php'; ?>
