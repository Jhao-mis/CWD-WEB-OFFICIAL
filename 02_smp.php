...
<head>
    ...
    <title>CWD Septage Management</title>
...
<body>
    ...
    <div class="relative bg-[#1a589e] text-white overflow-hidden py-16 sm:py-20 md:py-24">
                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                    ...
                    <li>
                        <div class="flex items-center space-x-1.5">
                            ...
                            <i class="fa-solid fa-truck-droplet w-5 mr-2"></i>
                            <a href="#"
                                class="inline-flex items-center text-m font-medium text-white hover:text-fg-brand">Septage
                                Management</a>
                        </div>
                    </li>
        ...
        <div class="container-fluid mx-auto text-center relative z-10 px-4">
            <h1 class="text-4xl md:text-5xl font-black text-white uppercase tracking-tight mb-4">Septage Management Program
            </h1>
        </div>
    ...
    <script>
        // Manually initialize the carousel if needed to ensure functionality
        document.addEventListener('DOMContentLoaded', function () {
            var myCarousel = document.querySelector('#faqCarousel');
