...
<body>
    ...
    <div class="relative bg-[#1a589e] text-white overflow-hidden py-16 sm:py-20 md:py-24">
                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                    ...
                    <li>
                        <div class="flex items-center space-x-1.5">
                            ...
                            <a href="#"
                                class="inline-flex items-center text-m font-medium text-white hover:text-fg-brand">Waste
                                Management</a>
                        </div>
                    </li>
        ...
        <div class="container-fluid mx-auto text-center relative z-10 px-4">
            <h1 class="text-4xl md:text-5xl font-black text-white uppercase tracking-tight mb-4">Waste Management
            </h1>
        </div>
    ...
    <div class="container mx-auto">
        <div class="row g-0 mt-4">
            ...
            <div class="col-sm-6 col-md-8 mb-4">
                ...
                <h5 class="inv text-slate-600">Invitation to Bid for the <span id="bacyear">Company Waste</span></h5>
                ...
                <div class="container mx-auto bo">
                        ...
                        <ul class="nav nav-pills shadow-sm rounded-pill p-1 bg-white" id="pills-tab" role="tablist">
                            ...
                            <li class="nav-item" role="presentation">
                                <button class="nav-link-pag" id="pills-q4-tab" data-bs-toggle="pill"
                                    ...
                                    aria-selected="true"><i class="fa-solid fa-dumpster"></i></button>
                            </li>
                    ...
                    <div class="tab-content" id="pills-tabContent">
                        ...
                        <!-- Tab Pane for 2023 -->
                        <div class="tab-pane fade active" id="pills-q1" role="tabpanel"
                            aria-labelledby="pills-2024-tab">
                            ...
                            <div
                                ...
                                <div class="p-8 text-center">
                                    ...
                                    <div
                                        ...
                                        <i class="fa-solid fa-dumpster text-[#1a589e] text-3xl"></i>
                                    </div>

                                    <!-- Content matched to model -->
                                    <h5 class="text-2xl font-bold text-[#1a589e] mb-4">
                                        No Available Waste for Bidding
                                    </h5>
                                    <p class="text-gray-600 mb-8">
                                        There is no available waste for bidding at this time. You can come back later!
                                    </p>

                                    <!-- Placeholder/Status Indicator (Optional: keeping the layout consistent with the action model) -->
                                    <div
                                        class="inline-flex items-center justify-center w-full px-6 py-3 text-[#1a589e] bg-blue-50 rounded-lg font-semibold border border-blue-100">
                            ...
                            <!-- For future use (Data Table for Company Waste)
                            <div class="content-table">
                                ...
                                <div id="scrollableTableBody">
                                    <div class="data-row">
                                        <a href="#" class="col-date bac text-left text-decoration-none">CWD 2025-01</a>
                                        <a href="#" class="col-title bac text-decoration-none">Company Waste Q1-Q2 2025</a>
                                        <div class="col-date">July 2025</div>
                                    </div>
            ...
            <div class="col-6 col-md-3 mx-auto">
                <nav class="nav flex-column sidebar-nav1">
                    <h4 class="text-2xl font-black text-[#1a589e] text-center uppercase tracking-wide mt-2 mb-2">
                        Bids and Awards</h4>
                    <a class="tab-card1" aria-current="page" href="./03_bac1">
                        <h5 class="font-bold text-sm"><i class="fa-solid fa-gavel"></i> Bidding Opportunities</h5>
                    </a>
                    <a class="tab-card1" href="./03_bac2">
                        <h5 class="font-bold text-sm"><i class="fa-solid fa-file-lines"></i> Bid Bulletin / Addendum
                        </h5>
                    </a>
                    <a class="tab-card1" href="./03_bac3">
                        <h5 class="font-bold text-sm"><i class="fa-solid fa-calendar-days"></i> Notice of Postponement
                        </h5>
                    </a>
                    ...
                    <h4 class="text-2xl font-black text-[#1a589e] text-center uppercase tracking-wide mt-2 mb-2">
                        Others</h4>
                    <a class="tab-card1 active" aria-current="page" href="./03_bac5">
