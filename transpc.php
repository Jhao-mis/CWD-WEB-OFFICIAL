...
<head>
    ...
    <title>CWD Transparency Seal</title>
...
<body>
    ...
    <div class="relative bg-[#1a589e] text-white overflow-hidden py-16 sm:py-20 md:py-24">
                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                    ...
                    <li>
                        <div class="flex items-center space-x-1.5">
                            ...
                            <a href="#"
                                class="inline-flex items-center text-m font-medium text-white hover:text-fg-brand">Transparency
                                Seal</a>
                        </div>
                    </li>
        ...
        <div class="container-fluid mx-auto text-center relative z-10 px-4">
            <h1 class="text-3xl sm:text-4xl md:text-5xl font-bold uppercase tracking-wide">Philippine Transparency Seal
            </h1>
        </div>
    ...
    <div
        ...
        <img class="rounded-full w-21 h-21 mx-auto" src="./img/icons/PTS.png" alt="image description">
        <br>

        <h5 class="mb-3 text-2xl font-semibold tracking-tight text-heading leading-8">S Y M B O L I S M</h5>
        <p class="text-justify text-body">A pearl buried inside a tightly-shut shell is practically worthless.
            Government
            information is a pearl, meant to be shared with the public in order to maximize its inherent value. The
            ...
            to exercise their right to participate in governance. This initiative is envisioned as a step in the
            right direction towards solidifying the position of the Philippines as the Pearl of the Orient – a
            shining example for democratic virtue in the region.</p>
