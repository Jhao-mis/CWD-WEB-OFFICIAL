        ...
        <div class="flex flex-col lg:flex-row gap-12">
            ...
            <div class="lg:w-2/3">
                ...
                <div class="relative w-full overflow-hidden rounded-2xl shadow-xl bg-black mb-8"
                    ...
                    <div class="carousel-track flex transition-transform duration-300 ease-in-out" id="carouselTrack">
                        <div class="carousel-slide flex-shrink-0 w-full relative">
                            <img src="..\assets\Files\gad\2022\others\1.jpg" class="w-full h-[500px] object-cover"
                                alt="Slide 1">
                            <div class="carousel-caption-overlay">
                                <p class="text-sm italic">Mother's Day & Father's Day Celebrations</p>
                            </div>
                        </div>

                        <div class="carousel-slide flex-shrink-0 w-full relative">
                            <img src="..\assets\Files\gad\2022\others\2.jpg" class="w-full h-[500px] object-cover"
                                alt="Slide 2">
                            <div class="carousel-caption-overlay">
                                <p class="text-sm italic">Mother's Day & Father's Day Celebrations</p>
                            </div>
                        ...
                        <div class="carousel-slide flex-shrink-0 w-full relative">
                            <img src="..\assets\Files\gad\2022\others\3.jpg" class="w-full h-[500px] object-cover"
                                alt="">
                            <div class="carousel-caption-overlay">
                                <p class="text-sm italic">Mother's Day & Father's Day Celebrations</p>
                            </div>
                        ...
                        <div class="carousel-slide flex-shrink-0 w-full relative">
                            <img src="..\assets\Files\gad\2022\others\4.jpg" class="w-full h-[500px] object-cover"
                                alt="">
                            <div class="carousel-caption-overlay">
                                <p class="text-sm italic">Mother's Day & Father's Day Celebrations</p>
                            </div>
                        ...
                        <div class="carousel-slide flex-shrink-0 w-full relative">
                            <img src="..\assets\Files\gad\2022\others\5.jpg" class="w-full h-[500px] object-cover"
                                alt="">
                            <div class="carousel-caption-overlay">
                                <p class="text-sm italic">Mother's Day & Father's Day Celebrations</p>
                            </div>
                        ...
                        <div class="carousel-slide flex-shrink-0 w-full relative">
                            <img src="..\assets\Files\gad\2022\others\6.jpg" class="w-full h-[500px] object-cover"
                                alt="">
                            <div class="carousel-caption-overlay">
                                <p class="text-sm italic">Mother's Day & Father's Day Celebrations</p>
                            </div>
                        ...
                        <div class="carousel-slide flex-shrink-0 w-full relative">
                            <img src="..\assets\Files\gad\2022\others\7.jpg" class="w-full h-[500px] object-cover"
                                alt="">
                            <div class="carousel-caption-overlay">
                                <p class="text-sm italic">Mother's Day & Father's Day Celebrations</p>
                            </div>
                        ...
                        <div class="carousel-slide flex-shrink-0 w-full relative">
                            <img src="..\assets\Files\gad\2022\others\rice1.jpg" class="w-full h-[500px] object-cover"
                                alt="">
                            <div class="carousel-caption-overlay">
                                <p class="text-sm italic">Distribution of 40kg Rice</p>
                            </div>
                        </div>

                        <div class="carousel-slide flex-shrink-0 w-full relative">
                            <img src="..\assets\Files\gad\2022\others\rice2.jpg" class="w-full h-[500px] object-cover"
                                alt="">
                            <div class="carousel-caption-overlay">
                                <p class="text-sm italic">Distribution of 40kg Rice</p>
                            </div>
                        ...
                        <div class="carousel-slide flex-shrink-0 w-full relative">
                            <img src="..\assets\Files\gad\2022\others\fount1.png" class="w-full h-[500px] object-cover"
                                alt="">
                            <div class="carousel-caption-overlay">
                                <p class="text-sm italic">Drinking Fountain for Public Schools</p>
                            </div>
                        </div>

                        <div class="carousel-slide flex-shrink-0 w-full relative">
                            <img src="..\assets\Files\gad\2022\others\fount2.png" class="w-full h-[500px] object-cover"
                                alt="">
                            <div class="carousel-caption-overlay">
                                <p class="text-sm italic">Drinking Fountain for Public Schools</p>
                            </div>
                ...
                <div class="article-content">
                    <h2>Mother's Day & Father's Day Celebrations</h2>
                    <p>
                        CWD joined the celebrations for Mother's Day and Father's Day on May 15 and June 15, 2022,
                        respectively. Tokens were distributed to the mothers and fathers of CWD in recognition of their
                        incomparable roles as pillars of the family.
                    </p>

                    <h2>Distribution of 40kg Rice</h2>
                    <p>
                        In recognition of their contributions toward women’s empowerment and gender equality, the
                        Management distributed 40 kilos of Dinorado rice to eighty (80) female employees. Additionally,
                        two sacks of rice were donated to the elderly residents of Bahay ni Maria Home for the Abandoned
                        Elderly and Children with Special Needs in Brgy. Sampiruhan, Calamba City.
                    </p>

                    <h2>Drinking Fountain for Public Schools</h2>
                    <p>
                        As part of its GAD initiatives, CWD donated drinking fountains to public schools within Calamba
                        City. Beneficiaries of this program included Calamba Science Integrated School and Palingon
                        Elementary School.
                    </p>
