        ...
        <div class="flex flex-col lg:flex-row gap-12">
            ...
            <div class="lg:w-2/3">
                ...
                <div class="relative w-full overflow-hidden rounded-2xl shadow-xl bg-black mb-8"
                    ...
                    <div class="carousel-track flex transition-transform duration-300 ease-in-out" id="carouselTrack">
                        ...
                        <div class="carousel-slide flex-shrink-0 w-full relative">
                            <img src="..\assets\Files\gad\2024\others\tmt.jpg" class="w-full h-[500px] object-cover"
                                alt="Slide 1">
                            <div class="carousel-caption-overlay">
                                <p class="text-sm italic">That's My Tatay 2024</p>
                            </div>
                        </div>

                        <div class="carousel-slide flex-shrink-0 w-full relative">
                            <img src="..\assets\Files\gad\2024\others\tmt1.jpg" class="w-full h-[500px] object-cover"
                                alt="Slide 1">
                            <div class="carousel-caption-overlay">
                                <p class="text-sm italic">That's My Tatay 2024</p>
                            </div>
                        ...
                        <div class="carousel-slide flex-shrink-0 w-full relative">
                            <img src="..\assets\Files\gad\2024\others\tmt2.jpg" class="w-full h-[500px] object-cover"
                                alt="">
                            <div class="carousel-caption-overlay">
                                <p class="text-sm italic">That's My Tatay 2024</p>
                            </div>
                        ...
                        <div class="carousel-slide flex-shrink-0 w-full relative">
                            <img src="..\assets\Files\gad\2024\others\tmt3.jpg" class="w-full h-[500px] object-cover"
                                alt="">
                            <div class="carousel-caption-overlay">
                                <p class="text-sm italic">That's My Tatay 2024</p>
                            </div>
                        ...
                        <div class="carousel-slide flex-shrink-0 w-full relative">
                            <img src="..\assets\Files\gad\2024\others\tmt4.jpg" class="w-full h-[500px] object-cover"
                                alt="">
                            <div class="carousel-caption-overlay">
                                <p class="text-sm italic">That's My Tatay 2024</p>
                            </div>
                ...
                <div class="article-content">
                    Highlighting the 2024 Mid-Year Activities and Team Building at Caliraya Resort Club, Inc., CWD
                    successfully hosted the coronation night for the first-ever Search for That’s My Tatay on June 13,
                    2024. This event recognized the vital role of fathers as pillars of the family and the organization.

                    We extend our deepest appreciation to General Manager Exequiel "Jhun" Aguilar, the Board of
                    Directors, and the Special Events Committee for their unwavering support. Special thanks also go to
                    our sponsors, choreographers, and the panel of judges for making this milestone event a success.
                    <br><br>

                    <h2>Award Recipients</h2><br>

                    <dt>Grand Winner, Best in Talent, & Mr. Photogenic</dt>
                    <dd>Rannie Nato Vasquez</dd><br>

                    <dt>1st Runner Up & Best in Casual Wear</dt>
                    <dd>Paul Evangelista</dd><br>

                    <dt>2nd Runner Up & Best in Talent</dt>
                    <dd>Dominic Naag</dd><br>

                    <dt>3rd Runner Up</dt>
                    <dd>Allan Albaira</dd><br>

                    <dt>Best in Ramp Modeling</dt>
                    <dd>Marnel Fellizar De las Alas</dd><br>

                    <dt>Darling of the Crowd</dt>
                    <dd>Eroll Caponga</dd><br>

                    <dt>People's Choice Award</dt>
                    <dd>Joseph Pamplona</dd>
                </div>
