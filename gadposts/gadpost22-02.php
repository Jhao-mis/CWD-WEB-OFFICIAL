        ...
        <div class="flex flex-col lg:flex-row gap-12">
            ...
            <div class="lg:w-2/3">
                ...
                <div class="relative w-full overflow-hidden rounded-2xl shadow-xl bg-black mb-8"
                    ...
                    <div class="carousel-track flex transition-transform duration-300 ease-in-out" id="carouselTrack">
                        <div class="carousel-slide flex-shrink-0 w-full relative">
                            <img src="..\assets\Files\gad\2022\others\sem1.jpg" class="w-full h-[500px] object-cover"
                                alt="Slide 2">
                            <div class="carousel-caption-overlay">
                                <p class="text-sm italic">Seminar-Workshop on GMEF and GAD Agenda</p>
                            </div>
                        </div>

                        <div class="carousel-slide flex-shrink-0 w-full relative">
                            <img src="..\assets\Files\gad\2022\others\sem2.jpg" class="w-full h-[500px] object-cover"
                                alt="Slide 3">
                            <div class="carousel-caption-overlay">
                                <p class="text-sm italic">Seminar-Workshop on GMEF and GAD Agenda</p>
                            </div>
                        ...
                        <div class="carousel-slide flex-shrink-0 w-full relative">
                            <img src="..\assets\Files\gad\2022\others\gst.jpg" class="w-full h-[500px] object-cover"
                                alt="Slide 1">
                            <div class="carousel-caption-overlay">
                                <p class="text-sm italic">Gender Sensitivity Training</p>
                            </div>
                        </div>
                ...
                <div class="article-content">
                    <h2>Seminar-Workshop on GMEF and GAD Agenda</h2>
                    <p>
                        To mainstream GAD programs, CWD conducted a Seminar-Workshop on the Gender Mainstreaming
                        Evaluation Framework (GMEF) and the Preparation of the Indicative GAD Agenda on October 24-25,
                        2022. Attended by the GAD Focal Point System, Technical Working Group, and Secretariat, the
                        session was facilitated by Dr. Blesshe L. Querijero of the PCW GAD Resource Pool. The assessment
                        results from this workshop serve as the foundation for the CWD 3-Year GAD Agenda and the annual
                        GAD Plan and Budget.
                    </p>

                    <h2>Gender Sensitivity Training</h2>
                    <p>
                        To promote gender responsiveness, CWD conducted Gender Sensitivity Training in three batches
                        throughout 2022. Held at Monte Vista Resort, Pansol, the training targeted newly hired
                        employees, with 37 participants per batch from various departments.
                    </p>
