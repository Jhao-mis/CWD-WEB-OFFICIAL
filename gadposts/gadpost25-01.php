        ...
        <div class="flex flex-col lg:flex-row gap-12">
            ...
            <div class="lg:w-2/3">
                ...
                <div class="relative w-full overflow-hidden rounded-2xl shadow-xl bg-black mb-8"
                    ...
                    <div class="carousel-track flex transition-transform duration-300 ease-in-out" id="carouselTrack">
                        ...
                        <div class="carousel-slide flex-shrink-0 w-full relative">
                            <img src="..\assets\Files\gad\2025\wihs\wihs.png" class="w-full h-[500px] object-cover"
                                alt="Slide 1">
                            <div class="carousel-caption-overlay">
                                <p class="text-sm italic">Walk In Her Shoes Activity 2025</p>
                            </div>
                        </div>

                        <div class="carousel-slide flex-shrink-0 w-full relative">
                            <img src="..\assets\Files\gad\2025\wihs\wihs1.jpg" class="w-full h-[500px] object-cover"
                                alt="Slide 1">
                            <div class="carousel-caption-overlay">
                                <p class="text-sm italic">Walk In Her Shoes Activity 2025</p>
                            </div>
                        ...
                        <div class="carousel-slide flex-shrink-0 w-full relative">
                            <img src="..\assets\Files\gad\2025\wihs\wihs2.jpg" class="w-full h-[500px] object-cover"
                                alt="Slide 2">
                            <div class="carousel-caption-overlay">
                                <p class="text-sm italic">Walk In Her Shoes Activity 2025</p>
                            </div>
                        ...
                        <div class="carousel-slide flex-shrink-0 w-full relative">
                            <img src="..\assets\Files\gad\2025\wihs\wihs3.jpg" class="w-full h-[500px] object-cover"
                                alt="Slide 3">
                            <div class="carousel-caption-overlay">
                                <p class="text-sm italic">Walk In Her Shoes Activity 2025</p>
                            </div>
                        ...
                        <div class="carousel-slide flex-shrink-0 w-full relative">
                            <img src="..\assets\Files\gad\2025\wihs\wihs4.jpg" class="w-full h-[500px] object-cover"
                                alt="Slide 4">
                            <div class="carousel-caption-overlay">
                                <p class="text-sm italic">Walk In Her Shoes Activity 2025</p>
                            </div>
                        ...
                        <div class="carousel-slide flex-shrink-0 w-full relative">
                            <img src="..\assets\Files\gad\2025\wihs\wihs5.jpg" class="w-full h-[500px] object-cover"
                                alt="Slide 5">
                            <div class="carousel-caption-overlay">
                                <p class="text-sm italic">Walk In Her Shoes Activity 2025</p>
                            </div>
                ...
                <div class="article-content">
                    On March 11, 2025, Calamba Water District continued its powerful tradition with the "Walk in Her
                    Shoes" event, held in observance of National Women’s Month. This year’s theme, "Kababaihan ng CWD,
                    Kaagapay sa PaghahanGAD ng Magandang Bukas para sa Bagong Pilipinas," emphasized the vital
                    partnership of women in striving for a brighter future under the Bagong Pilipinas vision.
                    The event featured male employees participating in a symbolic walk while wearing high heels, an act
                    designed to foster empathy and showcase solidarity with women. The 2025 initiative highlighted three
                    defining pillars: High Self-Esteem, Excellence in Virtue, and Resilience. By championing these
                    values, CWD reaffirms its commitment to an inclusive workplace where gender equality is a shared
