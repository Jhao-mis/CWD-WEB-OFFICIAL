        ...
        <div class="flex flex-col lg:flex-row gap-12">
            ...
            <div class="lg:w-2/3">
                ...
                <div class="relative w-full overflow-hidden rounded-2xl shadow-xl bg-black mb-8"
                    ...
                    <div class="carousel-track flex transition-transform duration-300 ease-in-out" id="carouselTrack">
                        <div class="carousel-slide flex-shrink-0 w-full relative">
                            <img src="..\assets\Files\gad\2022\wihs\1.jpg"
                                class="w-full h-[500px] object-cover" alt="Slide 1">
                            <div class="carousel-caption-overlay">
                                <p class="text-sm italic">Walk In Her Shoes Activity 2022</p>
                            </div>
                        </div>

                        <div class="carousel-slide flex-shrink-0 w-full relative">
                            <img src="..\assets\Files\gad\2022\wihs\2.jpg"
                                class="w-full h-[500px] object-cover" alt="Slide 2">
                            <div class="carousel-caption-overlay">
                                <p class="text-sm italic">Walk In Her Shoes Activity 2022</p>
                            </div>
                        </div>
                        ...
                        <div class="carousel-slide flex-shrink-0 w-full relative">
                            <img src="..\assets\Files\gad\2022\wihs\3.jpg"
                                class="w-full h-[500px] object-cover" alt="Slide 3">
                            <div class="carousel-caption-overlay">
                                <p class="text-sm italic">Walk In Her Shoes Activity 2022</p>
                            </div>
                        </div>
                        ...
                        <div class="carousel-slide flex-shrink-0 w-full relative">
                            <img src="..\assets\Files\gad\2022\wihs\4.jpg"
                                class="w-full h-[500px] object-cover" alt="Slide 4">
                            <div class="carousel-caption-overlay">
                                <p class="text-sm italic">Walk In Her Shoes Activity 2022</p>
                            </div>
                        </div>
                        ...
                        <div class="carousel-slide flex-shrink-0 w-full relative">
                            <img src="..\assets\Files\gad\2022\wihs\5.jpg"
                                class="w-full h-[500px] object-cover" alt="Slide 5">
                            <div class="carousel-caption-overlay">
                                <p class="text-sm italic">Walk In Her Shoes Activity 2022</p>
                            </div>
                        </div>
                        ...
                        <div class="carousel-slide flex-shrink-0 w-full relative">
                            <img src="..\assets\Files\gad\2022\wihs\6.jpg"
                                class="w-full h-[500px] object-cover" alt="Slide 6">
                            <div class="carousel-caption-overlay">
                                <p class="text-sm italic">Walk In Her Shoes Activity 2022</p>
                            </div>
                        </div>
                        ...
                        <div class="carousel-slide flex-shrink-0 w-full relative">
                            <img src="..\assets\Files\gad\2022\wihs\7.jpg"
                                class="w-full h-[500px] object-cover" alt="Slide 7">
                            <div class="carousel-caption-overlay">
                                <p class="text-sm italic">Walk In Her Shoes Activity 2022</p>
                            </div>
                        </div>
                        ...
                        <div class="carousel-slide flex-shrink-0 w-full relative">
                            <img src="..\assets\Files\gad\2022\wihs\8.jpg"
                                class="w-full h-[500px] object-cover" alt="Slide 8">
                            <div class="carousel-caption-overlay">
                                <p class="text-sm italic">Walk In Her Shoes Activity 2022</p>
                            </div>
                        </div>
                ...
                <div class="article-content">
                    <p>
                        The Calamba Water District (CWD) celebrated National Women's Month, spearheaded by the
                        Philippine Commission on Women (PCW), in recognition of women's roles and contributions to all
                        facets of society. To commemorate the event, the "Walk in Her Shoes" activity—themed "Adhikain
                        ni Juana... HanGAD CWD na Maunlad"—was held on March 07, 2022. Male employees participated by
                        wearing high heels to appreciate the roles, experiences, and achievements of women.
                    </p>

                    <h2>Key Awards:</h2>
                    <p>
                    <dl>
                        Below are the personnel awarded and honored on various award categories.<br><br>

                        <dt>Wearing the Tallest Heels:</dt>
                        <dd>Mr. Ambrosio Jamila, Jr.</dd><br>

                        <dt>Best in Projection and Wearing Heels for the Whole Eight Working Hours:</dt>
                        <dd>Mr. John Norman Tidon.</dd><br>

                        <dt>Most Participative Department:</dt>
                        <dd>Administrative Department (for the greatest number of male employees wearing at least 2-inch
                            heels).</dd><br>
                    </dl>
                    </p>
                </div>
