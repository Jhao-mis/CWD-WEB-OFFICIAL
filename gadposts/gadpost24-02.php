        ...
        <div class="flex flex-col lg:flex-row gap-12">
            ...
            <div class="lg:w-2/3">
                ...
                <div class="relative w-full overflow-hidden rounded-2xl shadow-xl bg-black mb-8"
                    ...
                    <div class="carousel-track flex transition-transform duration-300 ease-in-out" id="carouselTrack">
                        ...
                        <div class="carousel-slide flex-shrink-0 w-full relative">
                            <img src="..\assets\Files\gad\2024\others\gcwd.jpg" class="w-full h-[500px] object-cover"
                                alt="Slide 1">
                            <div class="carousel-caption-overlay">
                                <p class="text-sm italic">Gandang CWD & Fab Over 40</p>
                            </div>
                        </div>

                        <div class="carousel-slide flex-shrink-0 w-full relative">
                            <img src="..\assets\Files\gad\2024\others\gcwd1.jpg" class="w-full h-[500px] object-cover"
                                alt="Slide 1">
                            <div class="carousel-caption-overlay">
                                <p class="text-sm italic">Gandang CWD & Fab Over 40</p>
                            </div>
                        ...
                        <div class="carousel-slide flex-shrink-0 w-full relative">
                            <img src="..\assets\Files\gad\2024\others\gcwd2.jpg" class="w-full h-[500px] object-cover"
                                alt="Slide 1">
                            <div class="carousel-caption-overlay">
                                <p class="text-sm italic">Gandang CWD & Fab Over 40</p>
                            </div>
                        ...
                        <div class="carousel-slide flex-shrink-0 w-full relative">
                            <img src="..\assets\Files\gad\2024\others\gcwd3.jpg" class="w-full h-[500px] object-cover"
                                alt="Slide 1">
                            <div class="carousel-caption-overlay">
                                <p class="text-sm italic">Gandang CWD & Fab Over 40</p>
                            </div>
                        ...
                        <div class="carousel-slide flex-shrink-0 w-full relative">
                            <img src="..\assets\Files\gad\2024\others\gcwd4.jpg" class="w-full h-[500px] object-cover"
                                alt="Slide 1">
                            <div class="carousel-caption-overlay">
                                <p class="text-sm italic">Gandang CWD & Fab Over 40</p>
                            </div>
                ...
                <div class="article-content">
                    As part of the National Women’s Month celebration, CWD honored the invaluable contributions and
                    sacrifices of women in nation-building. To promote empowerment and confidence, the District launched
                    its inaugural search for Gandang CWD: Fab Over 40 and Fab Over 50 on March 22, 2024, at the Jose
                    Rizal Coliseum. We take pride in our empowered employees who showcased their confidence and
                    excellence, contributing to a more just and equitable environment. <br><br>

                    <h2>Award Recipients</h2><br>

                    <dt>Gandang CWD</dt>
                    <dd>Ms. Joana Leana Mae Villanueva</dd><br>

                    <dt>Fab Over Forty</dt>
                    <dd>Mrs. Rowena Garcia</dd><br>

                    <dt>Fab Over Fifty</dt>
                    <dd>Mrs. Juliana Haca</dd>
                </div>
