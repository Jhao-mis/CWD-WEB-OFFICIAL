        ...
        <div class="flex flex-col lg:flex-row gap-12">
            ...
            <div class="lg:w-2/3">
                ...
                <div class="relative w-full overflow-hidden rounded-2xl shadow-xl bg-black mb-8"
                    ...
                    <div class="carousel-track flex transition-transform duration-300 ease-in-out" id="carouselTrack">
                        <div class="carousel-slide flex-shrink-0 w-full relative">
                            <img src="..\assets\Files\gad\2023\wihs\1.jpg" class="w-full h-[500px] object-cover"
                                alt="Slide 1">
                            <div class="carousel-caption-overlay">
                                <p class="text-sm italic">Walk In Her Shoes Activity 2023</p>
                            </div>
                        </div>

                        <div class="carousel-slide flex-shrink-0 w-full relative">
                            <img src="..\assets\Files\gad\2023\wihs\2.jpg" class="w-full h-[500px] object-cover"
                                alt="Slide 2">
                            <div class="carousel-caption-overlay">
                                <p class="text-sm italic">Walk In Her Shoes Activity 2023</p>
                            </div>
                        ...
                        <div class="carousel-slide flex-shrink-0 w-full relative">
                            <img src="..\assets\Files\gad\2023\wihs\3.jpg" class="w-full h-[500px] object-cover"
                                alt="Slide 3">
                            <div class="carousel-caption-overlay">
                                <p class="text-sm italic">Walk In Her Shoes Activity 2023</p>
                            </div>
                        ...
                        <div class="carousel-slide flex-shrink-0 w-full relative">
                            <img src="..\assets\Files\gad\2023\wihs\4.jpg" class="w-full h-[500px] object-cover"
                                alt="Slide 4">
                            <div class="carousel-caption-overlay">
                                <p class="text-sm italic">Walk In Her Shoes Activity 2023</p>
                            </div>
                        ...
                        <div class="carousel-slide flex-shrink-0 w-full relative">
                            <img src="..\assets\Files\gad\2023\wihs\5.jpg" class="w-full h-[500px] object-cover"
                                alt="Slide 5">
                            <div class="carousel-caption-overlay">
                                <p class="text-sm italic">Walk In Her Shoes Activity 2023</p>
                            </div>
                ...
                <div class="article-content">
                    In celebration of National Women’s Month and the launch of the 2023–2028 theme, "WE for Gender
                    Equality and Inclusive Society," the Calamba Water District (CWD) conducted its annual "Walk in Her
                    Shoes" program. As a gender-responsive workplace, CWD encouraged male employees to participate to
                    foster a more inclusive environment. The initiative aims to inform and engage everyone in
                    recognizing women’s roles, enabling them to contribute more effectively to nation-building.
                </div>
