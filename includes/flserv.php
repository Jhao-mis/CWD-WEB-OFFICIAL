<section class="container mx-auto">
        <div class="">
            ...
            <div class="">
                ...
                <!-- Citizen's Charter -->
                <h3 class="text-2xl font-black text-[#1a589e] text-center uppercase tracking-wide mt-2 mb-2">Citizen's Charter</h3>
    ...
    <div class="space-y-1.5">
        ...
        <button onclick="switchTab(event, 'wbill')" class="tab-card active w-full flex items-center px-4 py-3 text-left rounded-xl transition-all duration-200 font-bold text-sm">
            <i class="fas fa-receipt mr-3 text-base shrink-0 w-5 text-center"></i>
            <span>Payment of Water Bill</span>
        </button>

        <button onclick="switchTab(event, 'estimate')" class="tab-card w-full flex items-center px-4 py-3 text-left rounded-xl transition-all duration-200 font-bold text-sm">
            <i class="fa-solid fa-bullseye mr-3 text-base shrink-0 w-5 text-center"></i>
            <span>Application for Estimate</span>
        </button>

        <button onclick="switchTab(event, 'reconn')" class="tab-card w-full flex items-center px-4 py-3 text-left rounded-xl transition-all duration-200 font-bold text-sm">
    ...
    <div class="space-y-1.5">
        ...
        <button onclick="switchTab(event, 'disconn')" class="tab-card w-full flex items-center px-4 py-3 text-left rounded-xl transition-all duration-200 font-bold text-sm">
            <i class="fas fa-unlink mr-3 text-base shrink-0 w-5 text-center"></i>
            <span>For Disconnection</span>
        </button>

        <button onclick="switchTab(event, 'ledger')" class="tab-card w-full flex items-center px-4 py-3 text-left rounded-xl transition-all duration-200 font-bold text-sm">
            <i class="fas fa-file-invoice mr-3 text-base shrink-0 w-5 text-center"></i>
            <span>For Account Ledger Copy</span>
        </button>

        <button onclick="switchTab(event, 'name-change')" class="tab-card w-full flex items-center px-4 py-3 text-left rounded-xl transition-all duration-200 font-bold text-sm">
    ...
    <div class="space-y-1.5">
        ...
        <button onclick="switchTab(event, 'watconn')" class="tab-card w-full flex items-center px-4 py-3 text-left rounded-xl transition-all duration-200 font-bold text-sm">
            <i class="fas fa-plug mr-3 text-base shrink-0 w-5 text-center"></i>
            <span>New Water Service Connection</span>
        </button>

        <button onclick="switchTab(event, 'compl')" class="tab-card w-full flex items-center px-4 py-3 text-left rounded-xl transition-all duration-200 font-bold text-sm">
    ...
    <div class="space-y-1.5">
        ...
        <button onclick="switchTab(event, 'bulks')" class="tab-card w-full flex items-center px-4 py-3 text-left rounded-xl transition-all duration-200 font-bold text-sm">
            <i class="fas fa-truck mr-3 text-base shrink-0 w-5 text-center"></i>
            <span>Payment of Bulk Sale</span>
        </button>

        <button onclick="switchTab(event, 'wata')" class="tab-card w-full flex items-center px-4 py-3 text-left rounded-xl transition-all duration-200 font-bold text-sm">
                                ...
                                <div
                                    ...
                                    <div class="grid md:grid-cols-2 gap-6 mb-8">
                                        ...
                                        <div>
                                            ...
                                            <ul class="text-xs space-y-1 list-disc list-inside text-gray-700">
                                                <li>1. Signed Written Authorization – One (1) Original or One (1)
                                                    Photocopy</li>
                                            </ul>
                                        </div>
                                    </div>
                                            ...
                                            <tbody class="bg-white divide-y divide-yellow-200">
                                                <tr>
                                                    <td class="px-4 py-2 text-sm text-gray-900">1. Get a queuing ticket
                                                        from the Lobby Guard for Public Assistance <br> Location: Lobby</td>
                                    ...
                                    <div class="bg-gray-50 border border-gray-200 rounded-lg p-6 mt-8">
                                        ...
                                        <ul class="text-sm space-y-2 text-gray-700 list-disc list-inside">
                                            ...
                                            <li>The discount may be availed through over the counter payment at Calamba
                                                Water District Main Office and Extension Offices at Canlubang and
                                                Mercado De Calamba.</li>
                                        </ul>
                                    </div>
                                            ...
                                            <tbody class="bg-white divide-y divide-yellow-200">
                                                ...
                                                <tr>
                                                    <td class="px-4 py-2 text-sm text-gray-900">3. Payment of Filing Fee
                                                        <br> Location: Treasury Section (Lobby)</td>
                                ...
                                <div
                                    ...
                                    <div class="overflow-x-auto mb-8">
                                        ...
                                        <div class="bg-gray-50 border border-gray-200 rounded-lg p-6 mt-8">
                                            ...
                                            <ul class="text-sm space-y-2 text-gray-700 list-disc list-inside">
                                                <li>The account name must be changed or updated prior to processing of reconnection if the owner is already deceased or the property was already sold.</li>
                                                <li>The water bill deposit must be updated to Php 1,500.00 for Residential Connection or Php 3,000.00 for Commercial Connection.</li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <tbody class="bg-white divide-y divide-yellow-200">
                                                ...
                                                <tr>
                                                    <td class="px-4 py-2 text-sm text-gray-900">4. Endorse Request to
                                                        the Billing and Meter Reading Division <br> Location: One-Stop-Shop
                                                    </td>
                                    ...
                                    <div class="overflow-x-auto mb-8">
                                        <table class="min-w-full bg-yellow-50 border border-yellow-200 rounded-lg">
                                            ...
                                            <tbody class="bg-white divide-y divide-yellow-200">
                                                ...
                                                <tr>
                                                    <td class="px-4 py-2 text-sm text-gray-900">2. Receive and review
                                                        the submitted documents, and issue of Order of Payment <br> Location:
                                                        One-Stop-Shop</td>
                                    ...
                                    <div class="overflow-x-auto mb-8">
                                        <table class="min-w-full bg-yellow-50 border border-yellow-200 rounded-lg">
                                            ...
                                            <tbody class="bg-white divide-y divide-yellow-200">
                                                <tr>
                                                    <td class="px-4 py-2 text-sm text-gray-900">1. Get a queuing ticket
                                                        from the Lobby Guard for New Connection <br> Location: Lobby</td>
                                                    <td class="px-4 py-2 text-center text-sm text-gray-900">1 minute /
                                                        No Fee</td>
                                                    <td class="px-4 py-2 text-center text-sm text-gray-900">Guard on
                                                        Duty; Security Services</td>
                                                ...
                                                <tr>
                                                    <td class="px-4 py-2 text-sm text-gray-900">2. Verification of
                                                        Application on the New Connection System <br> Location: One-Stop-Shop
                                                    </td>
                                                    <td class="px-4 py-2 text-center text-sm text-gray-900">3 minutes /
                                                        No Fee</td>
                                                    <td class="px-4 py-2 text-center text-sm text-gray-900">Customer
                                                ...
                                                <tr>
                                                    <td class="px-4 py-2 text-sm text-gray-900">2.1 Evaluation and
                                                        Acceptance of Documentary Requirements <br> Location: One-Stop-Shop
                                                    </td>
                                                    <td class="px-4 py-2 text-center text-sm text-gray-900">5 minutes /
                                                        No Fee</td>
                                                    <td class="px-4 py-2 text-center text-sm text-gray-900">Customer
                                                ...
                                                <tr>
                                                    <td class="px-4 py-2 text-sm text-gray-900">5. Encoding and
                                                        ...
                                                        Signing of Service Connection Contract <br> Location: One-Stop-Shop
                                                    </td>
                                    ...
                                    <div class="overflow-x-auto mb-8">
                                        <table class="min-w-full bg-yellow-50 border border-yellow-200 rounded-lg">
                                            ...
                                            <tbody class="bg-white divide-y divide-yellow-200">
                                                <tr>
                                                    <td class="px-4 py-2 text-sm text-gray-900">1. Get a queuing ticket
                                                        from the Lobby Guard for Complaint/Request <br> Location: Lobby</td>
                                                    <td class="px-4 py-2 text-center text-sm text-gray-900">1 minute /
                                                        No Fee</td>
                                                    <td class="px-4 py-2 text-center text-sm text-gray-900">Guard on
                                                        Duty; Security Services</td>
                                            ...
                                            <tbody class="bg-white divide-y divide-yellow-200">
                                                ...
                                                <tr>
                                                    <td class="px-4 py-2 text-sm text-gray-900">3. Proceed to Bucal Pump
                                                        Station for the withdrawal of bulk water <br> Location: Bucal Pump
                                            ...
                                            <tbody class="bg-white divide-y divide-yellow-200">
                                                ...
                                                <tr>
                                                    <td class="px-4 py-2 text-sm text-gray-900">4. Payment of Ground
                                                        Water Assessment Bill <br> Location: Treasury Section (Lobby)</td>
                                                    <td class="px-4 py-2 text-center text-sm text-gray-900">5 minutes/
