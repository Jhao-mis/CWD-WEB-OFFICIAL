...
[
    ...
    [
        ...
        [
            'title' => 'Freedom of Information Feedback',
            'years' => [
                ['year' => 'Google Form', 'url' => 'https://docs.google.com/forms/d/e/1FAIpQLScdARfc7WRfL-jw9k6FGm2k8EDqKxMN0-3a6nJFVYjq74_WOw/viewform'],
    ...
    [
        ...
        'B. SALN / Submission Filing' => 'Not Available',
            ...
            <div class="flex-1 p-6 lg:p-12 min-h-[600px] bg-white">
                ...
                <div class="ts-content-panel ts-panel-archive animate-fade-in">
                    ...
                    <div class="space-y-10">
                        ...
                        <!-- Archive Sections Loop (II to X) -->
                        <?php foreach ($archive_sections as $title => $content): ?>
                            <div class="section-container">
                                <h4 class="text-base font-bold text-slate-800 mb-4 flex items-center">
                                    <span class="w-8 h-[2px] bg-[#1a589e] mr-3"></span>
                                    <?php echo $title; ?>
                                ...
                                <div class="ml-11">
                                        ...
                                        <div class="space-y-4">
                                            <?php foreach ($content as $key => $val): ?>
                                                <?php if (is_string($key)): ?>
                                                    ...
                                                    <!-- Sub-section level (like Section X Annexes) -->
                                                    <div class="mt-4 mb-2">
                                                        <p class="text-xs font-black text-gray-400 uppercase tracking-tighter mb-3">
                                                            <?php echo $key; ?></p>
                                                        <div class="grid grid-cols-1 gap-2">
                                                            <?php if (is_array($val)): ?>
                                                                <?php foreach ($val as $doc): ?>
                                                                    <div class="flex items-center text-sm text-slate-600 py-1">
                                                                        <i class="fas fa-file-pdf text-[10px] mr-3 text-gray-300"></i>
                                                                        <span class="mr-2"><?php echo $doc['title']; ?></span>
                                                                        <span>(</span>

                                                                        <?php 
                                                                        $year_links = [];
                                                                        foreach ($doc['years'] as $y) {
                                                                            $year_links[] = '<a href="' . $y['url'] . '" target="_blank" class="hover:text-[#1a589e] hover:underline font-semibold">' . $y['year']  . '</a>';
                                                                        }
                                                                        echo implode('<span class="text-gray-400 mx-1">|</span>', $year_links);
                                                                        ?>
                                                            ...
                                                            <?php else: ?>
                                                                <span class="flex items-center text-sm link-disabled py-1">
                                                                    <i class="fas fa-ban text-[10px] mr-3 text-gray-300"></i>
                                                                    <?php echo $val; ?>
                                                                </span>
                                                            <?php endif; ?>
                                                        </div>
                                                ...
                                                <?php else: ?>
                                                    <!-- Normal document items under main section -->
                                                    <div class="flex items-center text-sm text-slate-600 py-1">
                                                        <i class="fas fa-file-pdf text-[10px] mr-3 text-gray-300"></i>
                                                        <span class="mr-2"><?php echo $val['title']; ?></span>
                                                        <span>(</span>
                                                        <?php 
                                                        $year_links = [];
                                                        foreach ($val['years'] as $y) {
                                                            $year_links[] = '<a href="'  . $y['url'] .  '" target="_blank" class="hover:text-[#1a589e] hover:underline font-semibold">' . $y['year']  . ' </a> ';
                                                        }
                                                        echo implode('<span class="text-gray-400 mx-1">|</span>', $year_links);
                                                        ?>
                                    ...
                                    <?php else: ?>
                                        <!-- String Status (e.g. Not Applicable / No Available Data) -->
                                        <span
                                            class="inline-flex items-center px-3 py-1 rounded-full bg-slate-100 text-slate-500 text-[10px] font-black uppercase">
                                            <i class="fas fa-ban text-[10px] mr-3 text-gray-300"></i>
                                            <?php echo $content; ?>
